          ...
          ?>
            ...
            <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 custom_col">
              <div class="card custom_card">
                <a class="custom-item-color" href="https://mtpmtp.000webhostapp.com/Chitietsanpham/Product/<?php echo $row["productId"] ?>">
                  <img src="<?php echo "https://mtpmtp.000webhostapp.com/AdminWeb/admin" . $row["image"] ?>" class="card-img-top custom_col_image custom-image-size" src="http://via.placeholder.com/280x280" width="100%">
