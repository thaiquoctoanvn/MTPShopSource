...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light ">
  ...
  <div class="container">
    <a class="navbar-brand" href="https://mtpmtp.000webhostapp.com/Home">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active custom-width">
          <a class="nav-link custom-font-menu" href="https://mtpmtp.000webhostapp.com/Home">Trang chủ <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item dropdown custom-width">
          <a href="https://mtpmtp.000webhostapp.com/AllProduct" class="nav-link custom-font-menu" id="navbarDropdown">Cửa Hàng
</a>
        ...
        <li class="nav-item dropdown custom-width account">
          ...
          <div class="dropdown-content custom-dropdown">
            ...
            <a class="dropdown-item custom-font-menu custom-minh custom-account-function custom-logout" href="https://mtpmtp.000webhostapp.com/BirdyBag">Đăng Xuất</a>
          </div>
        </li>
